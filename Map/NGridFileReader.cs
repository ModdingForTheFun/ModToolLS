...
namespace ModToolLS
{
    public class NGridFileReader
    {
        ...
        #region ColorPanel()
        /*
        public void ColorPanel(MapEditor mainForm)
        {
            int rowLenght = cellCountX;

            mainForm.setPanelSize(rowLenght);
            mainForm.setBounds(minBounds,maxBounds);
            ...
            for (int i = 0; i < cells.Count; i++)
            {
                ...
                mainForm.drawPixel(visionPathingColor,x,y);
            ...
            for (int i = 0; i < heightSamples.Count; i++)
            {
                ...
                //TODO get this values stored somewhere for defaukt hight

            }

            mainForm.finishDrawing();
        ...
        */
        ...
        private int GetBMPBytePadding(int countX)
        {
            ...
            if ((bytesPerRow % 4) != 0)
            {  // correcting for padding rows to 4-byte size offsets
