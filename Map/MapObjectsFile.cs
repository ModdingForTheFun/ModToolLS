...
namespace ModToolLS
{
    public class MapObjectsFile
    {
        ...
        public MapObjectsFileObject getObject(int pos)
        {
            return Objects.ElementAt(pos);
        }

        public void DeleteObject(MapObjectsFileObject OBJ)
        {
            Objects.Remove(OBJ);
        }

        public MapObjectsFileObject newObject()
        {
            return new MapObjectsFileObject("NewObject");
        }

        public void saveObject(MapObjectsFileObject OBJ)
        {
        ...
        public MapObjectType getObjectType(String Type)
        {
            ...
            switch (Type)
            {
                ...
                case ("Barrack Spawn"):
                    return MapObjectType.BarrackSpawn;
                    break;

                case ("Nexus Spawn"):
                    return MapObjectType.NexusSpawn;
                    break;

                case ("Level Size"):
                    return MapObjectType.LevelSize;
                    break;

                case ("Barrack"):
                    return MapObjectType.Barrack;
                    break;

                case ("Nexus"):
                    return MapObjectType.Nexus;
                    break;

                case ("Turret"):
                    return MapObjectType.Turret;
                    break;
                ...
                case ("Nav"):
                    return MapObjectType.Nav;
                    break;

                case ("Info"):
                    return MapObjectType.Info;
                    break;

                case ("LevelProp"):
                    return MapObjectType.LevelProp;
                    break;
            }
