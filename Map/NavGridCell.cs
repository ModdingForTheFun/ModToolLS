...
namespace ModToolLS
{
    ...
    public enum VisionPathingFlags
    {  // 16 bits, bitfield
    ...
    public enum RiverRegionFlags
    {  // 8 bits, bitfield (equality for original Nexus Blitz)
    ...
    public enum JungleQuadrantFlags
    {  // 4 bits, equality
